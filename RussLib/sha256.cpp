...
Errors : The message length should be no more than 55 characters.*/
vector<unsigned long> SHA::resize_block(vector<unsigned long> input)
{
...
vector<unsigned long> SHA::convert_to_binary(const string input)
{
...
vector<unsigned long> SHA::pad_to_512bits(vector<unsigned long> block)
{
...
string SHA::compute_hash(const vector<unsigned long> block)
{
	// Taken from the spec
